...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // images (project thumbnails) have loaded and settled the page's real
    // height — recalculate once everything has actually loaded (see
    // js/script.js for the same fix).
